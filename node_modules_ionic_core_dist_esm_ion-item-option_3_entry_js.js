(self["webpackChunkfll_tools"] = self["webpackChunkfll_tools"] || []).push([["node_modules_ionic_core_dist_esm_ion-item-option_3_entry_js"],{
...
const ItemSliding = class {
  ...
  connectedCallback() {
    ...
    return (0,_home_seshan_Documents_flltools_upstream_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      _this2.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-f49d994d.js */ 7279))).createGesture({
        el: _this2.el,
